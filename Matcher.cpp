...
void Matcher::setFeatureDetector(cv::Ptr<SURF>& detect)
{
    detector= detect;
}
// Set the descriptor extractor
void Matcher::setDescriptorExtractor(cv::Ptr<SURF>& desc)
{
    extractor= desc;
}
...
cv::Mat Matcher::ransacTest(
    ...
    cout<<"Fundamental Matrix using 8 points algorithm"<<endl;
    cout<<fundamental<<endl;
    cout<<"----------------------------------"<<endl;
    fundamental= cv::findFundamentalMat(
                                        cv::Mat(points1),cv::Mat(points2), // matches
                                        CV_FM_7POINT); // 8-point method
    cout<<"Fundamental Matrix using 7 points algorithm"<<endl;
    cout<<fundamental<<endl;
    return fundamental;
